...
class Users::RegistrationsController < Devise::RegistrationsController
  ...
  def configure_sign_up_params
    devise_parameter_sanitizer.permit(:sign_up, keys: [:firstname, :birthday_date, :weight, :height, :gender, :is_gluten_sensitive, :is_diabetic, :is_pregnant, :restricted_ingredient])
  end
